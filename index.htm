...
<html lang="en">
	<head>
		...
		<title>ICLI 2018 Conference Program</title>
		
		<link href="css/reset.css" rel="stylesheet">
		<link href="css/icli2018.css" rel="stylesheet">
...
<!-- 				<li><a href="#proceedings">Proceedings</a></li> -->
				...
				<li><a href="#doctoralsymposium">Doctoral Symposium</a></li>
			</ul>
		</nav>
		<main>
			<h2>Proceedings</h2>
			<p class="cover"><a href="ICLI2018.pdf"><img src="img/ICLI2018.jpg" alt="cover of the ICLI 2018 proceedings" /></a></p>
			<p><strong>ICLI 2018</strong>, 4th International Conference on Live Interfaces. Inspiration, Performance, Emancipation.</p>
			<p>Edited by José Alberto Gomes, Miguel Carvalhais, Rui Penha.<br />ISBN 978-989-746-170-5<br />241 pages.</p>
			<p><a href="ICLI2018.pdf">Download PDF</a></p>





			<h2 class="clear">Thursday, June 14</h2>
			<table>
				<tr>
					<td>14:00 <span><a href="https://goo.gl/maps/AxtZkyjrfDA2" target="_blank">FBAUP</a></span><span>PS13B</span></td>
					<td><strong>Doctoral Symposium</strong>
						<ul>
							<li class="qa">Chairs: Alice Eldridge, Thor Magnusson, Cristina Sá</li>
							<li>Luís Aly <cite><a href="#ds1">Performative Sound Design</a></cite></li>
							<li>Jack Armitage <cite><a href="#ds2">Supporting Live Craft Process in Digital Musical Instrument Design</a></cite></li>
							<li>Raul Masu <cite><a href="#ds3">DMIs Design: Fostering Authorship of Composers and Creativity of Performers</a></cite></li>
							<li>Terhi Marttila <cite><a href="#ds4">Playful Readings and Deeper Meanings</a></cite></li>
							<li>Francisca Gonçalves <cite><a href="#ds5">Acoustic Ecology as Tool for Environmental Awareness: The Ocean Soundscape</a></cite></li>
						</ul>
						<p>The Doctoral Symposium is limited to presenting participants and chairs.</p>
					</td>
				</tr>
				<tr>
					<td>21:00 <span><a href="https://goo.gl/maps/oavaUbmA94t" target="_blank">Passos Manuel</a></span></td>
					<td><strong>Conference Opening</strong></td>
				</tr>
				<tr>
					<td>21:30 <span><a href="https://goo.gl/maps/oavaUbmA94t" target="_blank">Passos Manuel</a></span></td>
					<td><strong>Performance Session 1</strong>
						<ul>
							<li>Joana Chicau and Renick Bell <cite><a href="#p1">Círculo e Meio</a></cite></li>
							<li>Ryan Kirkbride, Lucy Cheesman and Laurie Johnson <cite><a href="#p2">Fingerprints</a></cite></li>
							<li>Masato Kakinoki <cite><a href="#p4">Act: Study<br />Subject: History<br />Topic: _</a></cite></li>
						</ul>						
					</td>
				</tr>
			</table>
				
			<h2>Friday, June 15</h2>
			<table>
				<tr class="break">
					<td>9:00 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span></td>
					<td>Registration</td>
				</tr>
				<tr>
					<td>10:00 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span><span>Cyber</span></td>
					<td><strong>Keynote</strong>
						<ul>
							<li>Rajele Jain <cite><a href="#kn1">From the Natyashastra</a></cite></li>
						</ul>
					</td>
				</tr>
				<tr>
					<td>11:00 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span><span>Cyber</span></td>
					<td><strong>Paper Session 1</strong>
						<ul>
							<li class="qa">Chair: Pedro Pestana</li>
							<li>Vincent Goudard <cite><a href="#pp1">Gestural Ergonomics of Visual Interfaces: The MP.TUI Library for Max</a></cite></li>
							<li>Raul Masu and Nuno N. Correia <cite><a href="#pp2">Penguin: Design of a Screen Score Interactive System</a></cite></li>
							<li>Raffaella Folgieri, Maria Elide Vanutelli, Paola Maria Sala, Ludovico Dei Cas, Dario Dei Cas, and Claudio Lucchiari <cite><a href="#pp3">The Creative Mind: DRACLE Further Development</a></cite></li>
							<li>Henrique Portovedo, Paulo Ferreira-Lopes and Ricardo Mendes <cite><a href="#pp4">HASGS: The Repertoire as an Approach to Prototype Augmentation</a></cite></li>
							<li class="qa">Q&amp;A</li>
						</ul>
					</td>
				</tr>
				<tr class="break">
					<td>12:30 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span></td>
					<td>Lunch</td>
				</tr>
				<tr>
					<td>14:00 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span><span>Cyber</span></td>
					<td><strong>Paper Session 2</strong>
						<ul>
							<li class="qa">Chair: Marco Conceição</li>
							<li>Tiago Ângelo, Rui Penha, José Alberto Gomes and Pedro Rebelo <cite><a href="#pp5">Actuated Musical Instruments: a State of the Art</a></cite></li>
								<li>Visda Goudarzi, Enrique Tomás and Artemi-Maria Gioti <cite><a href="#pp6">Collaborative Design Methods towards Evaluation of a Tangible Interface</a></cite></li>
							<li>Alex McLean, Dave Griffiths and Ellen Harlizius-Klück <cite><a href="#pp7">Digital Art: A Long History</a></cite></li>
							<li>Thor Magnusson <cite><a href="#pp8">Ergomimesis: Towards a Language Describing Instrumental Transductions</a></cite></li>
							<li class="qa">Q&amp;A</li>
						</ul>
					</td>
				</tr>
				<tr>
					<td>15:30 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span><span>Sala de Ensaios 2</span></td>
					<td><strong>Performance Session 2</strong>
						<ul>
							<li>Filipe Lopes, Gilberto Bernardes and Clara Cardoso <cite><a href="#p6">Variações sobre Espaço #6</a></cite></li>
							<li>Marcin Pietruszewski <cite><a href="#p7">formulae si:v</a></cite></li>
							<li>Alice Eldridge, Chris Kiefer, Thor Magnusson and Thanos Polymeneas Liontiris <cite><a href="#p5">Brain Dead Ensemble: An Acoustically Networked Feedback Quartet</a></cite></li>
						</ul>	
					</td>
				</tr>				
				<tr class="break">
					<td>17:00 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span></td>
					<td>Coffee Break</td>
				</tr>
				<tr>
					<td>17:30 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span><span>Cyber</span></td>
					<td><strong>Performance Session 3</strong>
						<ul>
							<li>Henrique Portovedo <cite><a href="#p8">Performance Proposal</a></cite></li>
							<li>Joe Watson <cite><a href="#p9">The Thing Breathed</a></cite></li>
<!-- 							<li>Pedro Louzeiro and Henrique Portovedo <cite><a href="#p10">Comprovisação nº 9, for augmented saxophone (HASGS), ensemble and real-time composition and notation system (Comprovisador)</a></cite></li> -->
						</ul>
					</td>
				</tr>
			</table>
			...
			<table>
				<tr>
					...
					<td><strong>Keynote</strong>
						<ul>
							<li>Andrew McPherson <cite><a href="#kn2">Comparative Musical Instrument Design</a></cite></li>
						</ul>
					</td>
				</tr>
				<tr>
					<td>11:00 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span><span>Cyber</span></td>
					<td><strong>Paper Session 3</strong>
						<ul>
							<li class="qa">Chair: Pedro Cardoso</li>
							<li>Marije Baalman, Simon Emmerson and Øyvind Brandtsegg <cite><a href="#pp9">Instrumentality, Perception and Listening in Crossadaptive Performance</a></cite></li>
							<li>Michael Rottmann <cite><a href="#pp10">Before Ink Starts to Blink: Scripts and Diagrams on Paper as Interfaces for Machines and Humans (in Creative Processes)</a></cite></li>
							<li>Ricardo Melo and Miguel Carvalhais <cite><a href="#pp11">The Interactor Cedes Control: An Heuristic for Planned Serendipity in Interactive Systems</a></cite></li>
							<li>Thanos Polymeneas Liontiris, Thor Magnusson, Chris Kiefer and Alice Eldridge <cite><a href="#pp12">The Ensemble as Expanded Interface: Sympoetic Performance in the Brain Dead Ensemble</a></cite></li>
							<li class="qa">Q&amp;A</li>
						</ul>
					</td>
				</tr>
				...
				<tr>
					<td>14:00 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span><span>Cyber</span></td>
					<td><strong>Paper Session 4</strong>
						<ul>
							<li class="qa">Chair: Adriana Sá</li>
							<li>Cécile Chevalier and Chris Kiefer <cite><a href="#pp13">Listening Mirrors</a></cite></li>
							<li>Paul Granjon and Patrick Hénaff <cite><a href="#pp14">Guido and Am I Robot? Case Study of Two Robotic Artworks Operating in Public Spaces</a></cite></li>
							<li>Koichi Samuels and Hadi Bastani <cite><a href="#pp15">Digital Media, Live Interfaces and Inclusion: ethnographic perspectives</a></cite></li>
							<li class="qa">Q&amp;A</li>
						</ul>
					</td>
				</tr>
				<tr>
					<td>15:30 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span><span>Cyber</span></td>
					<td><strong>Paper Session 5</strong>
						<ul>
							<li class="qa">Chair: Luís Leite</li>							
							<li>Jung In Jung <cite><a href="#pp16">Bridging Abstract Sound and Dance Ideas with Technology: Interactive Dance Composition as Practice-Based Research</a></cite></li>
							<li>Renick Bell and Joana Chicau <cite><a href="#pp17">A Trans-Disciplinary Tool for Collaborative, Choreographed, and Embodied Audio-Visual Live Coding</a></cite></li>
							<li>Joanne Armitage and Shelly Knotts <cite><a href="#pp18">Vibez: A Small Sense of Presence at a Distance</a></cite></li>
							<li class="qa">Q&amp;A</li>
						</ul>
					</td>
				</tr>				
				<tr class="break">
					<td>17:00 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span><span>Sala de Ensaios 2</span></td>
					<td>Coffee Break</td>
				</tr>
				<tr>
					<td>17:30 <span><a href="https://goo.gl/maps/UFjGcPeSV4t" target="_blank">Casa da Música</a></span></td>
					<td><strong>Performance Session 4</strong>
						<ul>
<!-- 							<li>Nicole Carroll and John Ferguson <cite><a href="#p11">Nhoj Elocin</a></cite></li> -->
							<li>Amy Alexander and Curt Miller <cite><a href="#p3">A performance of PIGS: Percussive Image Gestural System</a></cite></li>
							<li>Lee Westwood and Danny Bright <cite><a href="#p12">Noise Peddler: A live exploration of the pedalboard as performance interface</a></cite></li>
							<li>Alexandra Tibbitts, John Sullivan and Brice Gatinet <cite><a href="#p13">A Method for Gestural Control of Augmented Harp Performance</a></cite></li>
							<li>Adriana Sá and John Klima <cite><a href="#p14">CityStrings</a></cite></li>
						</ul>
					</td>
				</tr>
				<tr class="break">
					<td>21:00 <span><a href="https://goo.gl/maps/gQteoMetUds" target="_blank">Silo Auto</a></span></td>
					<td>Conference Performative Dinner by Open Field</td>
				</tr>
				<tr>
					<td>23:59 <span><a href="https://goo.gl/maps/oavaUbmA94t" target="_blank">Passos Manuel</a></span></td>
					<td><strong>Performance Session 5</strong>
						<ul>
							<li>Joanne Armitage and Shelly Knotts <cite><a href="#p15">Vibez</a></cite></li>
							<li>Alex McLean <cite><a href="#p16">Yaxu: Feedforward</a></cite></li>
						</ul>
					</td>
				<tr>
					<td>01:00 <span><a href="https://goo.gl/maps/oavaUbmA94t" target="_blank">Passos Manuel</a></span></td>
					<td><strong>Closing Party &amp; Algorave</strong>
						<ul>
							<li>Lil Data</li>
							<li>Luuma</li>
							<li>Renick Bell</li>
							<li>Ryan Kirkbride</li>
			...
			<h3 id="p1">Joana Chicau and Renick Bell <cite>Círculo e Meio</cite></h3>
			<p>The performance reflects how language boundaries are enacted through the computing environment and society, exploring how movement, gestures, discourses, and behaviours are choreographed and communicated through these apparatuses, and how our hybrid systems and transdisciplinary research co-construct each other. It is informed by recollection of sources that reference principles of non-linear composition, non-hegemonic time and space constructs, and techno-feminist understandings. It combines two connected digital interfaces. Using a shared choreographic vocabulary, the performers create meaning around the act and conditions of coding.</p>
			<p><a href="pdf/ICLI2018-Chicau.pdf">Download PDF</a></p>
			
			<h3 id="p2">Ryan Kirkbride, Lucy Cheesman and Laurie Johnson <cite>Fingerprints</cite></h3>
			<p>Fingerprints is an improvised performance for collaborative live coding that explores ownership and identity within group creativity. It is performed by The Yorkshire Programming Ensemble (TYPE) and utilises a real-time concurrent multi-user text editor to facilitate meaningful creative exchanges in collaborative processes within the practice of live coding. The editor, Troop (Kirkbride 2017), allows multiple performers to share the same text buffer and write their own code while also interacting with code written by their co-performers. In fingerprints, each performer will work on code independently and create sound using “their own” musical algorithm before attempting to reshape their collaborators’ work. As this process continually repeats, the piece evolves and the performers are asked whether they can retain their own identities within a state of perpetual flux or if the communal process takes on a greater identity of its own.</p>
			<p><a href="pdf/ICLI2018-Kirkbride.pdf">Download PDF</a></p>
			
			<h3 id="p4">Masato Kakinoki <cite>Act: Study<br />Subject: History<br />Topic: _</cite></h3>
			<p>In this performance, fixity and fluidity of history, digital materials and of acts of documenting and recording will be explored by improvising the act of studying history, and improvising with the immediate recordings of the act. The recorded sounds of reading, writing, squiggling and perhaps occasional mumbling will be fluidified through the author’s physical manipulation. What the author does in the performance can be regarded as learning, examining, organising, disorganising, manipulating or forging both certain history and the act of learning it. The nature and the poetic sentiment of learning are other inherent elements behind the performance. The author is working on research-based art practice, particularly interested in the field of the culinary culture and human history, and of the sexual and marital culture and human history. He exposes his ongoing research process in the format of performance.
</p>
			<p><a href="pdf/ICLI2018-Kakinoki.pdf">Download PDF</a></p>

			<h3 id="p6">Filipe Lopes, Gilberto Bernardes and Clara Cardoso <cite>Variações sobre Espaço #6</cite></h3>		
			<p>We present Variações sobre Espaço #6, a mixed media work for saxophone and electronics that intersects music, digital technologies and architecture. The creative impetus supporting this composition is grounded in the interchange of the following two concepts: 1) the phenomenological exploration of the aural architecture (Blesse & Salter 2007) particularly the reverberation as a sonic effect (Augoyard & Torgue 2005) through music performance and 2) the real time sound analysis of both the performance and the reverberation (i.e. impulse responses) intervallic content — which ultimately leads to a generic control over consonance/dissonance (C/D). Their conceptual and morphological nature can be understood as sonic improvisations where the interaction of sound producing bodies (i.e. the saxophone) with the real (e.g. performance space) and the imaginary (i.e. computer) acoustic response of a space results in formal elements mirroring their physical surroundings.</p>
			<p><a href="pdf/ICLI2018-Lopes.pdf">Download PDF</a></p>
			
			<h3 id="p7">Marcin Pietruszewski <cite>formulae si:v</cite></h3>
			<p>The ‘formulae si:v’ is an experimental opera; a duo for synthetic voice and an algorithmic script for auditory scene formulation; an elemental synthetic laboratory where the sensible, the intelligible, the artificial, and the natural are animated and combined. Integrating a state of the art machine learning program, a novel hybrid sound and speech synthesis design, and an original spatialisation score, the work probes the experimental capacity of sound synthesis at the intersection between microsound, psychoacoustics and computational linguistics.</p>
			<p><a href="pdf/ICLI2018-Pietruszewski.pdf">Download PDF</a></p>
			
			<h3 id="p5">Alice Eldridge, Chris Kiefer, Thor Magnusson and Thanos Polymeneas Liontiris <cite>Brain Dead Ensemble: An Acoustically Networked Feedback Quartet</cite></h3>
